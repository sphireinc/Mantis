...
- [Constants](<#constants>)
- [Variables](<#variables>)
- [func GetBody(r *http.Request) ([]byte, error)](<#func-getbody>)
- [func GetQueryParameter(r *http.Request, key string) (string, error)](<#func-getqueryparameter>)
- [func GetQueryParameters(r *http.Request) url.Values](<#func-getqueryparameters>)
- [func ParseBodyIntoStruct(r *http.Request, obj interface{}) error](<#func-parsebodyintostruct>)
- [func ParseURL(rawurl string) (*url.URL, error)](<#func-parseurl>)
- [func StatusText(code int) string](<#func-statustext>)
- [type Request](<#type-request>)
  - [func (r *Request) Byte() []byte](<#func-request-byte>)
  - [func (r *Request) Get() *Response](<#func-request-get>)
  - [func (r *Request) Post() *Response](<#func-request-post>)
- [type Response](<#type-response>)
  - [func (r *Response) Byte() []byte](<#func-response-byte>)
- [type ResponseCodes](<#type-responsecodes>)
  - [func GetHTTPResponseCode(code int) ResponseCodes](<#func-gethttpresponsecode>)
  - [func (r *ResponseCodes) String() string](<#func-responsecodes-string>)
- [type ResponseJSONError](<#type-responsejsonerror>)
  - [func (r *ResponseJSONError) Byte() []byte](<#func-responsejsonerror-byte>)
- [type ResponseJSONOk](<#type-responsejsonok>)
  - [func (r *ResponseJSONOk) Byte() []byte](<#func-responsejsonok-byte>)
- [type Status](<#type-status>)
  - [func (s *Status) Fill()](<#func-status-fill>)
...
## func [StatusText](<https://github.com/sphireinc/mantis/blob/master/http/status.go#L430>)
...
## type [Status](<https://github.com/sphireinc/mantis/blob/master/http/status.go#L3-L103>)
...
### func \(\*Status\) [Fill](<https://github.com/sphireinc/mantis/blob/master/http/status.go#L105>)
